...
const ForgotPasswordScreen = ({ navigation }: any) => {
  ...
  const handleSendEmail = async () => {
    try {
      const response = await axios.post('https://wordpress.betaplanets.com/wp-json/custom/v1/forgotPassword', {
        email: email
      });
  ...
  const handleVerifyOTP = async () => {
    try {
      const response = await axios.post('https://wordpress.betaplanets.com/wp-json/custom/v1/checkOtp', {
        otp: otp,
        email: email
      });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await axios.post('https://wordpress.betaplanets.com/wp-json/custom/v1/updatePassword', {
        password: password,
        email: email
      });
